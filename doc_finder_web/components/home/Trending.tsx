...
import { TrendingUp, ChevronRight, Clock, Tag, BookOpen } from "lucide-react";
    ...
    <section className="py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading
            ...
            ? (
              <div className="col-span-3 text-center py-12 text-gray-400">
                ...
                <p>No trending articles right now.</p>
              </div>
            )
            : blogs.map(blog => {
                      ...
                      {Array.isArray(blog.tags) && blog.tags.length > 0 && (
                        <div className="flex items-center gap-1 mb-2 flex-wrap">
                          ...
                          {blog.tags.slice(0, 2).map(tag => (
                            <span key={tag} className="text-xs text-brand-500 bg-brand-50 px-2 py-0.5 rounded-full">{tag}</span>
                          ))}
                        </div>
                      )}
        ...
        <div className="sm:hidden mt-6 text-center">
          <Link href="/trending" className="btn-outline text-sm inline-flex items-center gap-1">
