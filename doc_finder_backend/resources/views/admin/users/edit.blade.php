                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('account_type') is-invalid @enderror"
                                ...
                                <option value="1" {{ old('account_type', $user->account_type) == '1' ? 'selected' : '' }}>Standard User</option>
                                <option value="2" {{ old('account_type', $user->account_type) == '2' ? 'selected' : '' }}>Service Provider</option>
                                <option value="3" {{ old('account_type', $user->account_type) == '3' ? 'selected' : '' }}>Admin</option>
                            </select>
                            @error('account_type')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('id_number') is-invalid @enderror"
                                   id="id_number" name="id_number" value="{{ old('id_number', $user->id_number) }}">
                            @error('id_number')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('licence_number') is-invalid @enderror"
                                       id="licence_number" name="licence_number" value="{{ old('licence_number', $user->licence_number) }}">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="sp_approved" name="sp_approved" value="1" {{ old('sp_approved', $user->sp_approved) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('professional_bio') is-invalid @enderror"
                                          id="professional_bio" name="professional_bio" rows="4">{{ old('professional_bio', $user->professional_bio) }}</textarea>
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input"
                                               ...
                                               {{ in_array($specialization->id, old('specializations', $userSpecializations)) ? 'checked' : '' }}>
